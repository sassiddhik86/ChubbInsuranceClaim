...
namespace ChubbInsuranceClaim.src.Application.Services
{
    public class ClaimWorkflowService : IClaimWorkflowService
    {
        ...
        public async Task AssignClaimAsync(
            int claimId,
            AssignClaimRequest request)
        {
            ...
            var officer =
                ...
                .GetByIdAsync(request.OfficerId);
            ...
            ClaimInformationRequest request)
        {
            ...
            claim.Status =
                ClaimStatus.NeedMoreInformation;
        ...
        public async Task SubmitInformationAsync(
            int claimId,
            ClaimInformationRequest request)
        {
            ...
            claim.Status =
                ClaimStatus.InformationReceived;
        ...
        public async Task ApproveClaimAsync(
            int claimId,
        ...
        public async Task SettleClaimAsync(
            int claimId,
            ClaimDecisionRequest request)
        {
        ...
        private async Task<InsuranceClaim> GetClaim(
            int id)
        {
